        ...
        <div class="album bg-light">
            <div class="container">
                <div class="row">
                    ...
                    <form class="form-group" metod="" action="">
                        <fieldset class="p-3">
                            <legend>Ajouter un whisky</legend>
                            <p class="mt-3">
                                <label for="name">Nom</label>
                                <input type="text" class="form-control" name="name" id="" aria-describedby="name" placeholder="" required>
                            ...
                            <p class="mt-3">
                                ...
                                <select name="category" id="" class="ml-3 aria-describedby="category" required">
                                    ...
                                    <option value="blend">Blended Malt</option>
                            ...
                            <p class="mt-3">
                                ...
                                <input type="text" class="form-control" name="distillery" id="" aria-describedby="Distillerie" required>
                            </p>
                            <p class="mt-3">
                                <label for="bottled">Date de mise en bouteille</label>
                                <input type="number" class="form-control" name="bottled" id="" min="4" max="4" aria-describedby="Date de mise en bouteille">
                                <small id="date_bouteille" class="form-text text-muted">Ex : 2010</small>
                            </p>
                            <p class="mt-3">
                                <label for="stated_age">Âge</label>
                                <input type="number" class="form-control" name="stated_age" id="" min="4" max="4" aria-describedby="Âge">
                                <small id="age_bouteille" class="form-text text-muted">Ex : 15</small>
                            </p>
                            <p class="mt-3">
                                <label for="strength">Degré d'alcool</label>
                                <input type="number" class="form-control" name="strength" id="" min="2" max="4" aria-describedby="Degré d'alcool" required>
                                <small id="degree_bouteille" class="form-text text-muted">Ex : 42,5</small>
                            </p>
                            <p class="mt-3">
                                <label for="flavor">Arômes</label>
                                <input type="text" class="form-control" name="flavor" id="" aria-describedby="Arômes" required>
                            </p>
                            <p class="mt-3">
                                <label for="description">Description</label>
                                <input type="text" class="form-control" name="description" id="" aria-describedby="Description">
                            </p>
                            <p class="mt-3">
